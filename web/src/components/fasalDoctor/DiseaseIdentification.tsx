...
import { 
  Camera, Upload, Scan, AlertTriangle, CheckCircle, 
  Loader2, ArrowRight, Info, X, Leaf, Microscope, 
  FileText, Sprout, ChevronRight, Share2, Save, MessageCircle,
  Droplets, Sun, Shield, Award, Zap, Sparkles, User, Users,
  Clock, Calendar, Bug, Thermometer, Wind, CloudRain, MapPin, Search
} from "lucide-react";
...
const DiseaseIdentification = () => {
  ...
  const analyzeImage = () => {
    ...
    setTimeout(() => {
      ...
      setAnalysisResults(data.sampleResults);
  ...
  const getRecommendations = () => {
    ...
    // Find matching treatment by disease name (in a real app, this would be more sophisticated)
    return treatmentRecommendations.find(
      treatment => treatment.disease.toLowerCase() === analysisResults.diseaseName.toLowerCase()
    ) || {
      disease: analysisResults.diseaseName,
      treatments: fallbackTreatmentData.treatments,
    ...
    return [
      {
        ...
        date: "15 May 2023",
        description: "Identified early signs of infection on lower leaves. Applied organic neem-based solution as recommended and practiced field sanitation. Complete recovery within 3 weeks.",
        severity: "medium",
        treatmentSuccess: 95,
  ...
  const getCommunityInsights = () => {
    ...
    return diagnosisHistory.filter(
      history => history.disease.toLowerCase().includes(analysisResults.diseaseName.toLowerCase())
    ).slice(0, 3) || fallbackCaseHistoryData.map(item => ({
      ...item,
      disease: analysisResults.diseaseName
    }));
  };
            ...
            <div className="md:col-span-1">
              <Card className="border-green-100 shadow-md h-full">
                ...
                <CardContent className="p-4">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-amber-700">
                          This AI analysis provides only preliminary diagnosis. Consult an agricultural expert for final decisions.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-4">
                    <h4 className="text-sm font-medium text-gray-700 mb-2">Common Crop Diseases</h4>
                    <div className="space-y-2">
                      {commonDiseases.slice(0, 3).map((disease) => (
                        ...
                        >
                          ...
                          <div>
                            <p className="text-sm font-medium text-gray-700">{disease.name}</p>
                            <p className="text-xs text-gray-500">{disease.crops.join(", ")}</p>
                          </div>
                        </div>
                      ))}
                    </div>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <CardDescription className="text-green-100 mt-1 flex items-center gap-2">
                            ...
                            <span className={`text-sm capitalize px-2 py-0.5 rounded-full ${
                              analysisResults.severity === 'high' ? 'bg-red-400/30' : 
                              analysisResults.severity === 'medium' ? 'bg-amber-400/30' : 'bg-green-400/30'
                            }`}>
                      ...
                      <div className="md:col-span-2">
                        <div className="p-5">
                          <h3 className="text-lg font-medium text-gray-800 mb-4 flex items-center gap-2">
                            ...
                            <span>{data.resultsSection.diseaseDetailsTitle}</span>
                          </h3>
                          
                          <div className="space-y-4">
                            <div>
                              <p className="text-gray-700 mb-3">{analysisResults.description}</p>
                            </div>
                  ...
                  <CardContent className="p-5">
                    {getRecommendations() ? (
                      <div className="space-y-5">
                        {getRecommendations()?.treatments.map((treatment, index) => (
                          <motion.div 
                            key={index}
                            variants={itemVariants}
                              ...
                              <div className="flex-1">
                                <h4 className="font-medium text-blue-800 flex items-center gap-2">
                                  ...
                                  <Badge className={`ml-2 ${
                                    ...
                                    {treatment.effectiveness.charAt(0).toUpperCase() + treatment.effectiveness.slice(1)} Effectiveness
                                  </Badge>
                                </h4>
                        ...
                        <div className="mt-6">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            {getRecommendations()?.preventiveMeasures.map((measure, index) => (
                              <motion.div 
                                key={index}
                                variants={itemVariants}
                      ...
                      <div className="p-6 text-center">
                        ...
                        <h3 className="text-lg font-medium text-gray-700 mb-2">No Specific Treatments Found</h3>
                        <p className="text-gray-500 max-w-md mx-auto">
                          We couldn't find specific treatment recommendations for this disease in our database. 
                          Consider consulting with an agricultural expert for personalized advice.
                        </p>
                  ...
                  <CardContent className="p-4">
                    {getCommunityInsights().length > 0 ? (
                        ...
                        {getCommunityInsights().map((insight, index) => (
                          ...
                          >
                            <div className="flex items-start gap-3 mb-2">
                              ...
                              <div>
                                <h4 className="font-medium text-amber-800">{insight.author.name}</h4>
                            ...
                            <div className="flex justify-between items-center text-xs text-gray-500">
                              ...
                              <div className="flex items-center gap-1">
                                ...
                                <span>{insight.likes} farmers found this helpful</span>
                              </div>
                            </div>
                          </motion.div>
                        ))}
                      ...
                      <div className="p-4 text-center">
                        ...
                        <h3 className="text-base font-medium text-gray-700 mb-2">No Community Insights Yet</h3>
                        <p className="text-sm text-gray-500">
                          Be the first to share your experience or insights about dealing with this disease.
                        </p>
                  ...
                  <CardContent className="p-4">
                    <div className="space-y-3">
                      <div className="flex items-center justify-between p-2 rounded-lg bg-sky-50 border border-sky-100">
                        ...
                        <div className="text-right">
                          <span className="text-sm font-medium text-sky-700">25-30°C</span>
                      ...
                      <div className="flex items-center justify-between p-2 rounded-lg bg-sky-50 border border-sky-100">
                        ...
                        <div className="text-right">
                          <span className="text-sm font-medium text-sky-700">70-85%</span>
                          <p className="text-xs text-gray-500">High Risk</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between p-2 rounded-lg bg-sky-50 border border-sky-100">
                        ...
                        <div className="text-right">
                          <span className="text-sm font-medium text-sky-700">5-10 km/h</span>
                    ...
                    <div className="mt-4 p-3 bg-amber-50 rounded-lg border border-amber-100">
                      <div className="flex items-start gap-2">
                        <AlertTriangle className="h-5 w-5 text-amber-600 flex-shrink-0 mt-0.5" />
                        <div>
                          <p className="text-sm font-medium text-amber-800 mb-1">Weather Alert</p>
                          <p className="text-xs text-amber-700">
                            Current weather conditions are favorable for disease spread. Consider preventive measures immediately.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <Card className="border-green-100 shadow-md overflow-hidden">
                  <CardHeader className="bg-gradient-to-r from-green-600/90 to-green-500/90 text-white py-4">
                    ...
                    <CardDescription className="text-green-50 mt-1">
                      Learn from other farmers who successfully managed similar issues
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="p-0">
                    {getSimilarCases().length > 0 ? (
                              ...
                              <div className="flex justify-between items-start mb-3">
                                <div className="flex items-center gap-3">
                                  <Avatar className="h-12 w-12 border-2 border-green-100 ring-2 ring-green-50">
                                    <AvatarImage src={caseItem.farmerAvatar} alt={caseItem.farmerName} />
                                    <AvatarFallback className="bg-gradient-to-br from-green-500 to-green-600 text-white font-medium">
                                      {caseItem.farmerName.split(' ').map(n => n[0]).join('')}
                                    </AvatarFallback>
                                  </Avatar>
                                  <div>
                                    <h4 className="text-base font-semibold text-gray-800">{caseItem.farmerName}</h4>
                                    <div className="flex items-center gap-2 mt-0.5">
                                      <Badge variant="outline" className="text-xs bg-green-50 border-green-200 text-green-700 px-2 py-0.5 flex items-center gap-1">
                                        <span className="text-sm">🌾</span>
                                        {caseItem.crop}
                                      </Badge>
                                ...
                                <div className="flex flex-col items-end">
                                  ...
                                  <Badge className={`mt-1 text-xs ${
                                    caseItem.severity === "high" ? "bg-red-100 text-red-700 border-red-200" : 
                                    caseItem.severity === "medium" ? "bg-amber-100 text-amber-700 border-amber-200" : 
                                    "bg-green-100 text-green-700 border-green-200"
                                  }`}>
                                    <span>{
                                      caseItem.severity === "high" ? "⚠️" : 
                                      caseItem.severity === "medium" ? "⚡" : "✅"
                                    }</span>
                                    {caseItem.severity.charAt(0).toUpperCase() + caseItem.severity.slice(1)} Severity
                                  </Badge>
                                </div>
                              </div>
                                ...
                                <div className="mt-4 flex items-center justify-between">
                                  <div className="w-1/2">
                                    <div className="flex items-center justify-between mb-1">
                                      ...
                                      <span className="text-xs font-bold text-green-700">{caseItem.treatmentSuccess}%</span>
                                    </div>
                                    <div className="w-full bg-gray-200 rounded-full h-2.5 overflow-hidden">
                                      <div 
                                        className={`h-2.5 rounded-full ${
                                          caseItem.treatmentSuccess > 90 ? "bg-gradient-to-r from-green-400 to-green-500" : 
                                          caseItem.treatmentSuccess > 75 ? "bg-gradient-to-r from-green-300 to-green-400" : 
                                          "bg-gradient-to-r from-amber-400 to-amber-500"
                                        }`}
                                        style={{ width: `${caseItem.treatmentSuccess}%` }}
                                      ></div>
                                    </div>
                                  </div>
                                  
                                  <Button variant="outline" size="sm" className="text-green-600 hover:text-green-700 hover:bg-green-50 border-green-200 group">
                      ...
                      <div className="text-center p-8 bg-green-50/50">
                        ...
                        <p className="text-sm font-medium text-gray-700 mb-1">No similar cases found</p>
                        <p className="text-xs text-gray-500">We couldn't find any similar cases for this disease in our database.</p>
                      </div>
                    )}
                  </CardContent>
                  <CardFooter className="bg-green-50/70 py-3 px-5 flex justify-between items-center">
                    <p className="text-xs text-gray-600">Showing {getSimilarCases().length} similar cases</p>
                    <Button variant="ghost" size="sm" className="text-green-700 hover:text-green-800 hover:bg-green-100 text-xs h-8">
                      View All Cases
