...
const announcements = [
  {
    ...
    content:
      'सभी सदस्यों से अनुरोध है कि वे 15 अक्टूबर को सुबह 10:00 बजे गांव सामुदायिक हॉल में रबी सीजन योजना बैठक में भाग लें। हम फसल चयन, इनपुट खरीद और बाजार संबंध रणनीतियों पर चर्चा करेंगे।',
  ...
  },
  {
    ...
    date: '10 अक्टूबर, 2023',
    content:
      'हमें ऑर्गेनिक ऑयल्स कंपनी के साथ सरसों की सीधी खरीद के लिए एक नई साझेदारी की घोषणा करते हुए खुशी हो रही है। वे गुणवत्ता उत्पादन के लिए बाजार मूल्य से 5% अधिक प्रीमियम दे रहे हैं। इच्छुक किसान कृपया 20 अक्टूबर तक पंजीकरण करें।',
    author: 'विपणन समिति',
    priority: 'medium',
  },
]
...
const FPODashboard = ({ currentFpo }: any) => {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 flex items-center gap-1">
                ...
                {currentFpo._count.members} सदस्य • स्थापित {formatDate(currentFpo.createdAt)}
              </p>
            </div>
          </div>
            ...
            <div className="h-64 flex items-center justify-center">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  ...
                  <Tooltip
                    formatter={(value) => [`${value}%`, 'बचत प्रतिशत']}
                  />
                </PieChart>
              </ResponsiveContainer>
            </div>
                      ...
                      {activity.type === 'procurement' && (
                        <div className="mt-1 space-y-1">
                          ...
                          <div className="flex items-center justify-between">
                            <span className="text-xs text-gray-500">
                              {activity.participants} प्रतिभागी
                            </span>
                            <span className="text-xs text-green-600 font-medium">
                              बचत: {activity.savings}
                            </span>
                          </div>
                        </div>
                      )}
