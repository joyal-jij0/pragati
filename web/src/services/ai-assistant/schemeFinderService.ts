...
export const schemeFinderService = {
  ...
  generateRoadmap: async (scheme: GovernmentScheme, language: string = "en"): Promise<string[]> => {
    try {
      if (!GEMINI_API_KEY || GEMINI_API_KEY === "AIzaSyCBPKfBLV54IN1xp70sJ-ySt5lIq_UJb74") {
        // Return mock roadmap if no API key is provided
...
function getMockRoadmap(scheme: GovernmentScheme, language: string = "en"): string[] {
  if (language === "hi") {
    return [
      ...
      "📝 चरण 4: आवेदन फॉर्म को सही व्यक्तिगत और भूमि विवरण के साथ भरें",
      "📎 चरण 5: सभी आवश्यक दस्तावेजों की स्कैन की गई प्रतियां अपलोड करें",
      "💰 चरण 6: आवेदन शुल्क का भुगतान करें (यदि लागू हो)",
      "📤 चरण 7: अपना आवेदन जमा करें और संदर्भ संख्या नोट करें",
      "⏱️ चरण 8: संदर्भ संख्या का उपयोग करके अपने आवेदन की स्थिति को ट्रैक करें",
      "📱 चरण 9: अधिकारियों से आने वाले किसी भी सत्यापन कॉल या संदेशों का जवाब दें",
    ...
    return [
      ...
      "📎 ਕਦਮ 5: ਸਾਰੇ ਲੋੜੀਂਦੇ ਦਸਤਾਵੇਜ਼ਾਂ ਦੀਆਂ ਸਕੈਨ ਕੀਤੀਆਂ ਕਾਪੀਆਂ ਅਪਲੋਡ ਕਰੋ",
